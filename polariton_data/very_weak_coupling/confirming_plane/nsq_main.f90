...
sigma = 0.0d0
CALL xyz_bloch_to_rho(0.0d0,0.0d0,0.005d0,sigma(3:4,3:4))
WRITE(*,*) "sigma for x,y,z=(0.0,0.0,0.005)"
OPEN(16,FILE="wf_0.0_0.0_0.005.txt")
CALL print_mat(sigma)
DO i = 1, 1000000
...
sigma = 0.0d0
CALL xyz_bloch_to_rho(0.2d0,0.2d0,0.0274d0,sigma(3:4,3:4))
WRITE(*,*) "sigma for x,y,z=(0.2,0.2,0.0274)"
CALL print_mat(sigma)
OPEN(16,FILE="wf_0.2_0.2_0.00274.txt")
DO i = 1, 1000000
  CALL rk4_prop(dt,sigma,Hls,t_len,operators)
  WRITE(16,*) i*dt, REAL(REAL(sigma(1,1))), REAL(REAL(sigma(2,2))), &
    REAL(REAL(sigma(3,3))), REAL(REAL(sigma(4,4)))
...
sigma = 0.0d0
CALL xyz_bloch_to_rho(-0.2d0,-0.2d0,-0.0174d0,sigma(3:4,3:4))
WRITE(*,*) "sigma for x,y,z=(-0.2,-0.2,-0.0174)"
CALL print_mat(sigma)
OPEN(16,FILE="wf_-0.2_0.2_-0.0174.txt")
DO i = 1, 1000000
  CALL rk4_prop(dt,sigma,Hls,t_len,operators)
  WRITE(16,*) i*dt, REAL(REAL(sigma(1,1))), REAL(REAL(sigma(2,2))), &
    REAL(REAL(sigma(3,3))), REAL(REAL(sigma(4,4)))
