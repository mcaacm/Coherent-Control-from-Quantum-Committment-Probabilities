...
REAL*8, PARAMETER, DIMENSION(nbath) :: omegac = (/0.05d0,0.05d0/)
! Strength parameter in spectral density
REAL*8, PARAMETER, DIMENSION(nbath) :: eta = (/0.2d0,0.2d0/) !,0.025d0/) !0.001822766d0/) 
...
REAL*8, PARAMETER :: etac = 0.1000d0 !2193135d0 !0.005d0
...
INTEGER, PARAMETER :: n = 4 !400 !4 ! Truncated basis size, must be less than or equal to m
