...
! For FMO
INTEGER, PARAMETER :: FMO = 7
! Fot two coupled Spins
INTEGER, PARAMETER :: SB2 = 8
...
REAL*8, PARAMETER :: dt = 1.000d0 !duration / (ntimes - 1)
...
REAL*8, PARAMETER, DIMENSION(nbath) :: omegac = (/0.01d0,0.01d0/)
! Strength parameter in spectral density
REAL*8, PARAMETER, DIMENSION(nbath) :: eta = (/0.1d0,0.1d0/) !,0.025d0/) !0.001822766d0/) 
...
REAL*8, PARAMETER :: coeff_z = 0.6d0
...
INTEGER, PARAMETER :: n = 15 !400 !4 ! Truncated basis size, must be less than or equal to m
INTEGER, PARAMETER :: m = dim_nc*dim_nt*2 !dim_qc*dim_R ! Basis size for initial diagonalization (dim_nc*dim_nt*2 for a 2-surface CI)
...
! Two coupled SB problem
REAL*8, PARAMETER :: omega_sb1 = 1.0d0 ! First SB frequency
REAL*8, PARAMETER :: omega_sb2 = 0.99d0 ! Second SB frequency
REAL*8, PARAMETER :: lambda_sb = 0.0d0 ! SB coupling along sigma_x1*sigma_x2
REAL*8, PARAMETER :: sbgx1 = 0.0d0  ! Local bath sigma x 1
REAL*8, PARAMETER :: sbgx2 = 0.0d0  ! Local bath sigma x 2
REAL*8, PARAMETER :: sbgx3 = 1.0d0  ! Global bath sigma x1
REAL*8, PARAMETER :: sbgx4 = 1.0d0  ! Global bath  sigma x2
REAL*8, PARAMETER :: sbgz1 = 0.0d0  ! Local bath sigma z 1
REAL*8, PARAMETER :: sbgz2 = 0.0d0  ! Local bath sigma z 2
REAL*8, PARAMETER :: sbgz3 = 0.0d0  ! Global bath sigma z 1
REAL*8, PARAMETER :: sbgz4 = 0.0d0  ! Global bath sigma z 2 
...
INTEGER, PARAMETER :: bound2 = 2
INTEGER, PARAMETER :: bound3 = 3
INTEGER, PARAMETER :: bound4 = 4
